...
from deepclassifier.models import TextCNN, DPCNN, HAN,RCNN, RNNAtt
...
# 定义模型
my_model = RNNAtt(embedding_dim=embedding_matrix.shape[1], dropout_rate=0.5, num_class=5, hidden_size=256, num_layers=2,
...
my_trainer = Trainer(model_name="rcnn", model=my_model, train_loader=train_loader, dev_loader=dev_loader,
