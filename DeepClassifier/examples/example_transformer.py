...
parser.add_argument("--nb_encoder", dest="nb_encoder", type=int, metavar='<int>', default=2)
...
# 定义模型
my_model = Transformer(embedding_dim=embedding_matrix.shape[1], dropout_rate=0.5, num_class=5,
                   embedding_matrix=embedding_matrix, num_encoder=args.nb_encoder, requires_grads=args.freeze_emb)
...
my_trainer = Trainer(model_name="transformer", model=my_model, train_loader=train_loader, dev_loader=dev_loader,
